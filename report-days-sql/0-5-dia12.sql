...
update kcsep22 set zephra = true where id = 170;
...
select * from kcsep22 where usuario like '%2687%';
update kcsep22 set zephra = true where id = 176;
select * from kcsep22 where usuario like '%2578%';
select * from kcsep22 where usuario like '%1290%';
update kcsep22 set zephra = true where id = 178;
--
...
select * from kcsep22 where usuario like '%9379%';
update kcsep22 set bryan = true where id = 170;
...
update kcsep22 set bryan = true where id = 173;
select * from kcsep22 where usuario like '%5787%';
select * from kcsep22 where usuario like '%6821%';
update kcsep22 set bryan = true where id = 175;
select * from kcsep22 where usuario like '%1290%';
update kcsep22 set bryan = true where id = 178;
--
select * from kcsep22 where usuario like '%7559%';
update kcsep22 set xenoblur = true where id = 167;
select * from kcsep22 where usuario like '%1762%';
update kcsep22 set xenoblur = true where id = 168;
select * from kcsep22 where usuario like '%8941%';
select * from kcsep22 where usuario like '%2532%';
select * from kcsep22 where usuario like '%2687%';
update kcsep22 set xenoblur = true where id = 176;
select * from kcsep22 where usuario like '%2578%';
update kcsep22 set xenoblur = true where id = 184;
select * from kcsep22 where usuario like '%1290%';
update kcsep22 set xenoblur = true where id = 178;
select * from kcsep22 where usuario like '%2444%';
select * from kcsep22 where usuario like '%4491%';
--
update kcsep22 set zerotg = true where id = 182;
